...
from .views import RegisterStudentView, RegisterTeacherView, StudentSubjectListView, LoginView, TeacherSubjectListView
...
urlpatterns = [
    ...
    path('student/<int:pk>/home/', view=StudentSubjectListView.as_view(), name='student-home'),
